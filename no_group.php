...
<?php
  $title = "{$noti->titleNoti()} Group not found • ";
  $keywords = "eror, 404, document not found, webpage not found, , Share and capture world's moments";
  $desc = "There's been an error • ";
?>
